...
script.on_event(defines.events.on_gui_opened, function(event)                
	if event.gui_type ~= defines.gui_type.entity or not event.entity or event.entity.name ~= "storage-unit" then return end
	...
	local main_frame = player.gui.relative.add{
		type = "frame", name = "memory_unit_gui", caption = {"entity-name.storage-unit"}, direction = "vertical",
		anchor = {
